...
const ventureData: Record<string, any> = {
  techflow: {
    id: "techflow",
    name: "TechFlow",
              ...
              <div>
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    ...
                    <h1 className="text-4xl md:text-5xl font-bold text-primary font-syne">{venture.name}</h1>
        ...
        <section className="py-20 bg-white">
          <div className="container px-4 md:px-6">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
              {venture.metrics.map((metric: any, index: number) => {
            ...
            <div className="grid lg:grid-cols-2 gap-12">
              <div>
                ...
                <div className="space-y-4">
                  {venture.features.map((feature: string, index: number) => (
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {venture.technologies.map((tech: string) => (
        ...
        <section className="py-20 bg-white">
          <div className="container px-4 md:px-6">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {venture.achievements.map((achievement: string, index: number) => (
        ...
        <section className="py-20 bg-lynx-white">
          <div className="container px-4 md:px-6">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {venture.testimonials.map((testimonial: any, index: number) => (
                <Card key={index} className="border-none shadow-sm">
                  <CardContent className="p-6">
